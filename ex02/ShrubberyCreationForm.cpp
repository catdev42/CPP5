...
ShrubberyCreationForm::ShrubberyCreationForm() : AForm("Targetless RobotomyRequestForm", SIGNGRADE, EXECGRADE), target("no target")
{
    std::cout << GREY << "ShrubberyCreationForm default constructor" << RESET << std::endl;
    return;
}

ShrubberyCreationForm::ShrubberyCreationForm(std::string formTarget) : AForm("RobotomyRequestForm", SIGNGRADE, EXECGRADE), target(formTarget)
{
